...
set ICC_NUM_CPUS                  12            ;# number of cpus for distributed processing;
...
set ICC_IN_VERILOG_NETLIST_FILE "$DESIGN_NAME.mapped.v $HIERARCHICAL_DESIGNS.mapped.v" ;#1 to n verilog input files, spaced by blanks
