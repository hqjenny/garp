...
set ICC_NUM_CPUS                  4            ;# number of cpus for distributed processing;
					       ;# specify a number greater than 1 to enable it for classic router based route_opt and insert_redundant_via commands
set ICC_NUM_CORES                 4            ;# number of cores on the local host for multicore support;
...
set ICC_CREATE_MODEL              TRUE        ;# TRUE|FALSE; used for ILM/FRAM creation for the blocks in HRM
...
# RIMAS: added as part of RM script upgrade
...
set ICC_CTS_LAYER_LIST		"M3 M4 M5 M6 B1 B2"	;# clock tree layers, usually M3 and above
...
set ICC_POST_CLOCK_ROUTE_CTO	TRUE  	       	;# set to TRUE if you want to run Post route CTO after clock routing
...
set ICC_DBL_VIA_FLOW_EFFORT      MED            ;# LOW|MED|HIGH  - MED enables concurrent soft-rule dbl via insertion
...
set ICC_DP_VERBOSE_REPORTING		TRUE		;# TRUE|FALSE; generate additional reports before placement
...
set PNS_VOLTAGE_SUPPLY     		1.0           	;# Unit in Volts; default is 1.5
#YUNSUP: add virtual rail layer
set PNS_VIRTUAL_RAIL_LAYER 		"M2"              ;# Specify the metal layer you want to use as virtual rail
